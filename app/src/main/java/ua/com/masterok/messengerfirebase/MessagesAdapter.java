...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MessageViewHolder> {
    ...
    public MessageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // реалізація двох макетів в одному ресайклВью
        int layoutResId;
    ...
    // для відображення ще одного макету
    @Override
    // цей метод відправляє значення в якості другого параметра в метод onCreateViewHolder()
    ...
    static class MessageViewHolder extends RecyclerView.ViewHolder {
        ...
        public MessageViewHolder(@NonNull View itemView) {
            super(itemView);
            tvMessage = itemView.findViewById(R.id.text_view_message);
        }
    }
